...
{        
    ...
    $_SESSION["file"]='dept';
    include 'config.php'; 
    $sql = "INSERT INTO dept(department) VALUES ('".$val."')";
      // echo $sql; exit;
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-8">
                                    ...
                                    <div>
                                        <h4 class="card-title">Master Data- Add Department</h4>
                                         <div class="form-group row">
                                      
                                            <input type="text" class="form-control" name ="d" placeholder="Add Department"><p><p>
