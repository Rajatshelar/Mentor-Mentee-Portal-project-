...
{        
    ...
    $_SESSION["file"]='catagory';
    include 'config.php'; 
    $sql = "INSERT INTO catagory(catagory) VALUES ('".$val."')";
      //echo $sql; exit;
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-8">
                                    ...
                                    <div>
                                        <h4 class="card-title">Master Data-Add Catagory</h4>
                                         <div class="form-group row">
                                      
                                            <input type="text" class="form-control" name ="catagory" placeholder="Add catagory"><p><p>
