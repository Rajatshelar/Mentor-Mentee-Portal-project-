...
{        
    ...
    $_SESSION["file"]='classes';
    include 'config.php'; 
    $sql = "INSERT INTO classes(class) VALUES ('".$val."')";
    //$sql = "INSERT INTO classes(mentor_batch) VALUES ('".$vall."')";
      // echo $sql; exit;
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-8">
                                    ...
                                    <div>
                                        <h4 class="card-title">Master Data- Add Class</h4>
                                         <div class="form-group row">
                                      
                                            <input type="text" class="form-control" name ="d" placeholder="Add Class"><p><p>
