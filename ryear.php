...
{        
    ...
    $_SESSION["file"]='ryear';
    include 'config.php'; 
    $sql = "INSERT INTO ryear(year) VALUES ('".$val."')";
      //echo $sql; exit;
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-8">
                                    ...
                                    <div>
                                        <h4 class="card-title">Enter Recruitment Year</h4>
                                         <div class="form-group row">
                                      
                                            <input type="text" class="form-control" name ="ryear" placeholder="Add  validation committee name"><p><p>
